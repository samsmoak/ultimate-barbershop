...
export const metadata: Metadata = {
  title: "The Cuts",
  description:
    "The editorial portfolio of Ultimate Styles Barbershop. Precision fades, clean lineups, beard architecture, and kids cuts — photographed in-shop, cut in-house.",
};
